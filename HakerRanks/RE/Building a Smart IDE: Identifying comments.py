...
ptr = re.compile(r'(//[\w ]*|/\*.*?\*/)', re.DOTALL)

ptr = re.compile(r'(//.*|/\*[\S\s]*?\*/)')

# re.findall(r'\/\/.*|\/\*.*(?:[^\*\/]\n.*)*(?<=\*\/)'
# re.findall(r"/\*[\S\s]*?\*/|//.*",S)

data1 = """/*This is a program to calculate area of a circle after getting the radius as input from the user*/
#include<stdio.h>
int main()
{
